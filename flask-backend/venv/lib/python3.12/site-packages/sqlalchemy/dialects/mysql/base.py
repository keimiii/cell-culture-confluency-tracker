...
them ignored on a MySQL / MariaDB flask-backend, use a custom compile rule::
...
DELETE options also being ignored by the flask-backend.   Therefore MATCH should
...
class MySQLCompiler(compiler.SQLCompiler):
    ...
    def _render_json_extract_from_binary(
        ...
        if binary.type._type_affinity is sqltypes.Integer:
            ...
            # that hits each flask-backend and maybe make a requires rule for it?
