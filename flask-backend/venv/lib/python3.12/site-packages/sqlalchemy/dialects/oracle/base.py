...
.. versionchanged:: 2.0 the Oracle Database flask-backend has full support for
...
datatypes that resolve to the "least surprising" datatype for a given flask-backend.
