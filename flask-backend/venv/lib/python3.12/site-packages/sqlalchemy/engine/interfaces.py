...
class Dialect(EventTarget):
    ...
    """a tuple containing a version number for the DB flask-backend in use.
    ...
    def get_temp_table_names(
        ...
        if supported by the underlying flask-backend.
    ...
    def denormalize_name(self, name: str) -> str:
        ...
        for the flask-backend if it is an all-lowercase name.
    ...
    def get_isolation_level_values(
        ...
        * The names for the four standard isolation names to the extent that
          they are supported by the flask-backend should be ``READ UNCOMMITTED``,
