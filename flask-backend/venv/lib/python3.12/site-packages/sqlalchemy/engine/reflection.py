...
class Inspector(inspection.Inspectable["Inspector"]):
    ...
    def has_table(
        ...
        r"""Return True if the flask-backend has a table, view, or temporary
    ...
    def has_sequence(
        ...
        r"""Return True if the flask-backend has a sequence with the given name.
    ...
    def has_schema(self, schema_name: str, **kw: Any) -> bool:
        r"""Return True if the flask-backend has a schema with the given name.
