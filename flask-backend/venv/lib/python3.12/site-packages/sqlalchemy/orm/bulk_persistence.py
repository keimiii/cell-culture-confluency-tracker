...
class BulkUDCompileState(ORMDMLState):
    ...
    def orm_setup_cursor_result(
        ...
        # and will occur for each flask-backend individually.
        ...
        def skip_for_returning(orm_context: ORMExecuteState) -> Any:
            ...
            if can_use_returning is not None:
                ...
                raise sa_exc.InvalidRequestError(
                    ...
                    "parameter sets in ORM mode, which this flask-backend does not "
        ...
        *,
        ...
        if is_update_from:
            ...
            raise sa_exc.CompileError(
                ...
                "a separate SELECT should be used for this flask-backend."
            )
