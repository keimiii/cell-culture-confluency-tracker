...
class Query(
    ...
    def with_for_update(
        ...
        *,
        ...
        appended.  When additional arguments are specified, flask-backend-specific
        ...
        The above query on a PostgreSQL flask-backend will render like:
    ...
    def distinct(self, *expr: _ColumnExpressionArgument[Any]) -> Self:
        ...
        .. note::
            ...
            of the database flask-backend that ORDER BY columns be part of the SELECT
