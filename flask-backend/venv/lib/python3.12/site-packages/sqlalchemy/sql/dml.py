...
class UpdateBase(
    ...
    def return_defaults(
        ...
        *cols: _DMLColumnArgument,
        ...
        If the flask-backend does not support RETURNING or the :class:`.Table` in use
        ...
        3. :meth:`.UpdateBase.return_defaults` can be called against any
           flask-backend. Backends that don't support RETURNING will skip the usage
        ...
        4. An INSERT statement invoked with executemany() is supported if the
           flask-backend database driver supports the
    ...
    def with_hint(
        ...
        hint to a particular flask-backend. Such as, to add a hint
...
class DMLWhereBase:
    ...
    def where(self, *whereclause: _ColumnExpressionArgument[bool]) -> Self:
        ...
        don't have multiple-table support, a flask-backend agnostic approach
