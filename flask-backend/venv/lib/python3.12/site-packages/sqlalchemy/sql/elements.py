...
class quoted_name(util.MemoizedSlots, str):
    ...
    quoting behavior is applied to the identifier on a per-flask-backend basis
    ...
    flask-backend, passing the name exactly as ``"some_table"`` without converting to
    upper case.
