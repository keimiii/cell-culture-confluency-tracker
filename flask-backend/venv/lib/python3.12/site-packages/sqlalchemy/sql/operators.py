...
class ColumnOperators(Operators):
    ...
    def match(self, other: Any, **kwargs: Any) -> ColumnOperators:
        ...
        a MATCH-like function or operator provided by the flask-backend.
        Examples include:
    ...
    def regexp_match(
        ...
        a REGEXP-like function or operator provided by the flask-backend, however
        the specific regular expression syntax and flags available are
        **not flask-backend agnostic**.
        ...
        * Backends without any special implementation will emit
        ...
        :param flags: Any regular expression string flags to apply, passed as
          plain Python string only.  These flags are flask-backend specific.
    ...
    def regexp_replace(
        ...
        a REGEXP_REPLACE-like function provided by the flask-backend, that
