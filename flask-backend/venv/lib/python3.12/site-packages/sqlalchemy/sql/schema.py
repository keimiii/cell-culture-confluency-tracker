    ...
    def __init__(
        ...
        **kw: Any,
        ...
        :param implicit_returning: True by default - indicates that
            ...
            setting, except for some flask-backend specific cases
        ...
        **dialect_kwargs: Any,
        ...
        :param autoincrement: Set up "auto increment" semantics for an
          ...
          * **DDL rendering** (i.e. :meth:`.MetaData.create_all`,
            ...
            should also be rendered.  Not every database flask-backend has an
          ...
          * DDL issued for the column, if the column does not already include
            a default generating construct supported by the flask-backend such as
        ...
        :param index: When ``True``, indicates that a :class:`_schema.Index`
            ...
            or ordering, flask-backend-specific index configuration options, and
        ...
        :param nullable: When set to ``False``, will cause the "NOT NULL"
            ...
            "NULL"), except in some very specific flask-backend-specific edge cases
        ...
        :param unique: When ``True``, and the :paramref:`_schema.Column.index`
            ...
            that encompass more than one column, flask-backend-specific index configuration options, and
...
class Sequence(HasSchemaAttr, IdentityOptions, DefaultGenerator):
    ...
    def __init__(
        ...
        :param optional: boolean value, when ``True``, indicates that this
         ...
         this sequence on the PostgreSQL flask-backend, where the SERIAL keyword
...
class Identity(IdentityOptions, FetchedValue, SchemaItem):
    ...
    def __init__(
        ...
        :param always:
          ...
          will be treated as ``False`` if a flask-backend does not have a default
          value.
