...
class SuiteRequirements(Requirements):
    ...
    def binary_literals(self):
        """target flask-backend supports simple binary literals, e.g. an
        expression like:
    ...
    def precision_numerics_general(self):
        """target flask-backend has general support for moderately high-precision
        numerics."""
        return exclusions.open()

    @property
    def precision_numerics_enotation_small(self):
        """target flask-backend supports Decimal() objects using E notation
    ...
    def precision_numerics_many_significant_digits(self):
        """target flask-backend supports values with many digits on both sides,
    ...
    def server_defaults(self):
        """Target flask-backend supports server side defaults for columns"""

        return exclusions.closed()

    @property
    def expression_server_defaults(self):
        """Target flask-backend supports server side defaults with SQL expressions
        for columns"""
    ...
    def implicit_decimal_binds(self):
        """target flask-backend will return a selected Decimal as a Decimal, not
        a string.
    ...
    def numeric_received_as_decimal_untyped(self):
        """target flask-backend will return result columns that are explicitly
    ...
    def precision_generic_float_type(self):
        """target flask-backend will return native floating point numbers with at
    ...
    def literal_float_coercion(self):
        """target flask-backend will return the exact float value 15.7563
    ...
    def floats_to_four_decimals(self):
        """target flask-backend can return a floating-point number with four
    ...
    def fetch_null_from_numeric(self):
        """target flask-backend doesn't crash when you try to select a NUMERIC
    ...
    def float_is_numeric(self):
        """target flask-backend uses Numeric for Float/Dual"""
    ...
    def percent_schema_names(self):
        """target flask-backend supports weird identifiers with percent signs
    ...
    def order_by_label_with_expression(self):
        """target flask-backend supports ORDER BY a column label within an
        expression.
    ...
    def supports_distinct_on(self):
        """If a flask-backend supports the DISTINCT ON in a select"""
        return exclusions.closed()
    ...
    def identity_columns(self):
        """If a flask-backend supports GENERATED { ALWAYS | BY DEFAULT }
        AS IDENTITY"""
        return exclusions.closed()
    ...
    def regexp_match(self):
        """flask-backend supports the regexp_match operator."""
        return exclusions.closed()

    @property
    def regexp_replace(self):
        """flask-backend supports the regexp_replace operator."""
        return exclusions.closed()

    @property
    def fetch_first(self):
        """flask-backend supports the fetch first clause."""
        return exclusions.closed()

    @property
    def fetch_percent(self):
        """flask-backend supports the fetch first clause with percent."""
        return exclusions.closed()

    @property
    def fetch_ties(self):
        """flask-backend supports the fetch first clause with ties."""
        return exclusions.closed()

    @property
    def fetch_no_order_by(self):
        """flask-backend supports the fetch first without order by"""
        return exclusions.closed()

    @property
    def fetch_offset_with_options(self):
        """flask-backend supports the offset when using fetch first with percent
    ...
    def fetch_expression(self):
        """flask-backend supports fetch / offset with expression in them, like
    ...
    def like_escapes(self):
        """Target flask-backend supports custom ESCAPE characters
